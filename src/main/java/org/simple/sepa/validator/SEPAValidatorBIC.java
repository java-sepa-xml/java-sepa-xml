...
public class SEPAValidatorBIC implements SEPAValidator {
     ...
     */
    public boolean isValid(final String bic) throws SEPAValidatorBICFormatException {
        try {
            validateEmpty(bic);
            validateLength(bic);
            validateCase(bic);
    ...
    private void validateEmpty(final String bic) {
        if(bic == null) {
    ...
    private void validateLength(final String bic) {
    ...
    private void validateCase(final String bic) {
    ...
    private void validateBankCode(final String bic) {
    ...
    private void validateCountryCode(final String bic) {
    ...
    private void validateLocationCode(final String bic) {
    ...
    private void validateBranchCode(final String bic) {
